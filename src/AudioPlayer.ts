...
const AUDIO_SOURCES = [
  ...
  require('../assets/audio/quote_22.mp3'),
  require('../assets/audio/quote_23.mp3'),
  require('../assets/audio/quote_24.mp3'),
  require('../assets/audio/quote_25.mp3'),
  require('../assets/audio/quote_26.mp3'),
];
