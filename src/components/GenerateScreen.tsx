...
const styles = StyleSheet.create({
  ...
  title: {
    color: ORANGE, fontSize: 18, fontWeight: '900',
    letterSpacing: 6, textAlign: 'center', marginBottom: 24,
  },
  sectionLabel: {
    color: DIM, fontSize: 10, letterSpacing: 4,
    fontWeight: '700', marginHorizontal: 16, marginBottom: 10,
  },
  voiceRow: {
    flexDirection: 'row', flexWrap: 'wrap',
    gap: 8, paddingHorizontal: 16, marginBottom: 24,
  },
  voiceChip: {
  ...
  genButton: {
    backgroundColor: ORANGE, marginHorizontal: 16,
  ...
  row: {
    ...
    paddingVertical: 12, backgroundColor: CARD, gap: 10,
  },
  rowText: { flex: 1 },
